...
UNNETTED_OK = {
    ...
    "U1": ("3", "8", "3=ALERT(规格书 Block A 写明 NC,有意悬空);"
                     "若仍出现 8=VBUS,表示板文件尚未同步本次原理图修正"),
...
print("   当前板的焊盘 1+2 是左夹、3+4 是右夹;PAD_GROUPS 让只读比对按两个端子归并。")
print("   库封装已进一步改为左夹 pad 1×2、右夹 pad 2×2,以后更新 PCB 也不会退回旁路接法。")
