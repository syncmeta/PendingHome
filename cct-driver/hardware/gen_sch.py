...
for r in ("Q1", "Q2"):
    part(r, "C3281500", {"G": "PMOS_GATE", "D": "V24_PROT", "S": "V24_FUSED"})
part("R1", "C25803", {"1": "PMOS_GATE", "2": "GND"})
part("DZ1", "C19077410", {"K": "V24_FUSED", "A": "PMOS_GATE"})
part("Q3", "C20526", {"B": "MASTER_OFF_B", "C": "PMOS_GATE", "E": "GND"})
part("R2", "C25804", {"1": "MASTER_OFF_B", "2": "GND"})
part("R3", "C25803", {"1": "MASTER_OFF_B", "2": "GND"})
part("D1", "C19077580", {"K": "V24_PROT", "A": "GND"})
for i in range(1, 6):
    part(f"C{i}", "C2836439", {"+": "V24_PROT", "-": "GND"})
part("RS1", "C500614", {"1": "V24_PROT", "2": "V24_BUS"})
...
part("R62", "C25804", {"1": "RT_CLK", "2": "GND"})     # 占位:实为200k,C编号下单前替换
part("R63", "C25803", {"1": "V5_BUCK", "2": "FB_5V"})  # 占位:实为102k
part("R64", "C25804", {"1": "FB_5V", "2": "GND"})      # 占位:实为18.2k
part("R65", "C23162", {"1": "COMP", "2": "COMP_Z"})    # 占位:实为4.75k
part("C39", "C21117", {"1": "COMP_Z", "2": "GND"})
part("C40", "C14663", {"1": "COMP", "2": "GND"})       # 占位:实为120pF C0G
part("R66", "C25803", {"1": "V24_LOGIC", "2": "EN_BUCK"})  # 占位:实为590k
part("R67", "C25804", {"1": "EN_BUCK", "2": "GND"})    # 占位:实为40.2k
...
for (n, F, J, Qc, Qw, Rgc, Rgw, Rpc, Rpw, Dfc, Dfw_, Dtc, Dtw, Ce, Cm, Lc, Lw, Rlc, Rlw) in CH_TABLE:
    ...
    part(Lc, "C2297", {"A": CW + "_G", "K": Lc + "_K"})
    part(Lw, "C2297", {"A": WW + "_G", "K": Lw + "_K"})
    part(Rlc, "C23162", {"1": Lc + "_K", "2": "GND"})
    part(Rlw, "C23162", {"1": Lw + "_K", "2": "GND"})
