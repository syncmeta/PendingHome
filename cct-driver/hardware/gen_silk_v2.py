...
# ---------------------------------------------------------------- 上板边接口
T("USB-C  PROG", 64.0, 12.0, 0.65)  # 不能压 J2 的触点排(挡锡),也不能挤在
                                    # R9/R10 之间(渲染图上糊成一团)。放到 J2 右边、
                                    # H3 支撑孔下方那块空地上
T("SW1-4 + GND", 37.0, 9.9, 0.7)
T("UART 5V", 74.0, 10.6, 0.7)   # J10 的塑料体在渲染图上比封装外框还往下探一点,让开
T("I2C 3.3V", 112.0, 10.0, 0.7)
