...
# 只有几颗地缝合过孔。
# x=106.3 也是量出来的:脊椎的缝合过孔每 3mm 一列(…101.5 / 104.5),焊盘 2.7mm 宽
# **塞不进两列之间那 2.4mm**,所以挪到最东那一列(104.5)的东边,离它 0.15mm;
# 再往东 0.45mm 就是 U1 的 I2C 脚,不能再靠。
at("C46",  106.3,  65.00, 90)   # V24_BUS 高频陶瓷(1210,4.68 宽)
