...
# 中途要**穿过 V5_SYS 那条底层横轨(y=50)**,所以在 x=92 上一小段顶层跳过去 ——
# 两条都是底层的话就是实打实的交叉。
path([vl, (vl[0], 57.5), (92.0, 57.5)], B, W_PWR1, "V24_LOGIC")
via(92.0, 57.5, "V24_LOGIC")
path([(92.0, 57.5), (92.0, 45.0)], F, W_PWR1, "V24_LOGIC")
via(92.0, 45.0, "V24_LOGIC")
path([(92.0, 45.0), (c35[0], 45.0), (c35[0], c35[1])], B, W_PWR1, "V24_LOGIC")
...
for netname, rpull, ex, ey, turn in (("I2C_SCL", "R53", 126.4, 19.4, 59.8),
                                     ("I2C_SDA", "R52", 127.2, 20.4, 63.6)):
