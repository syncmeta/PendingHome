...
CH_ROWS = [
    ...
    ("输出电解/去耦/指示灯",         104.36, FP["ELEC8"][1]),
    ("续流二极管  SS36B ×2",        112.60, FP["SMB"][1]),
    ("输出 TVS  SMBJ26A ×2",       118.50, FP["SMB"][1]),
    ("栅源下拉 10k ×2",             122.99, FP["R0603"][1]),
...
ZONES = [
    ...
    ("A5", "栅极驱动区", 4.0, 62.0, 101.0, 71.0, "#ddd6fe",
     "U6 压在 CH1–CH4 质心、U7 压在 CH5–CH6 质心;12 颗 100Ω 栅阻紧贴驱动输出"),
...
ASSIGN = [
    ...
    ("A5", ["U6", "U7", "C14", "C15", "R13", "R14", "R15", "Q6",
            "R16", "R17", "R22", "R23", "R28", "R29",
            "R34", "R35", "R40", "R41", "R46", "R47", "TP5"]),
    ("B0", ["TP1"]),
...
def build_svg():
    ...
    s.text(5.5, 69.4, "U6 压 CH1–4 质心 x=68 · U7 压 CH5–6 质心 x=20 · "
                      "12 颗 100Ω 栅阻紧贴驱动输出", size=1.8, fill="#4c1d95")
    ...
    s.text(-M_L + 2, ly + 26.2,
           ...
           "脊椎双面 12mm 铜 + 每 3mm 一颗缝合过孔,15A 压降 32mV / 0.48W(IPC-2221 估算)",
           size=2.0, fill="#64748b")
